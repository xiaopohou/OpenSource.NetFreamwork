...
{
    public class DynamicToJson : DynamicObject
    {
        ...
        /// <summary>from JsonSring to DynamicToJson</summary>
        ...
        /// <summary>from JsonSringStream to DynamicToJson</summary>
        ...
        private static dynamic ToValue(XElement element)
        {
            ...
            switch (type)
            {
                ...
                case JsonType.array:
                    return new DynamicToJson(element, type);
                case JsonType.@null:
                default:
                    return null;
            }
        ...
        public DynamicToJson()
        {
            xml = new XElement("root", CreateTypeAttr(JsonType.@object));
            jsonType = JsonType.@object;
        }

        private DynamicToJson(XElement element, JsonType type)
        {
        ...
        private dynamic DeserializeValue(XElement element, Type elementType)
        {
            ...
            if (value is DynamicToJson)
            {
                value = ((DynamicToJson)value).Deserialize(elementType);
            }
